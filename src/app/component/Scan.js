...
import HelloWorldAR from './HelloWorldAR';
                    ...
                    this.state.menuIsOpen ?
                        ...
                        <>
                            ...
                            <ViroARSceneNavigator
                                autofocus={true}
                                initialScene={{
                                    scene: () => <HelloWorldAR navigation={this.props.navigation} visible={this._setVisible} setDescriptionVisible={this._setDescriptionVisible} />
                                }}
                                style={styles.f1}
                            />
